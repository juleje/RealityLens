...
function handleCheckpoints(data) {
    for (let i = 0; i < data.length; i++) {
        ...
        fetch('https://maps.googleapis.com/maps/api/geocode/json?latlng=' + checkpointData.location.latitude + ',' + checkpointData.location.longitude + '&key=AIzaSyBV5JQArOrxIOf4tMwC_x5TyjjFRfB1Vs8')
            .then(response => response.json())
            .then(function (data) {
                let address = ""
